...
bool SpnCheck_isTempSpnEnabled(const struct AppConfig* cfg, uint16_t spn) {
...
bool SpnCheck_isPressureSpnEnabled(const struct AppConfig* cfg, uint16_t spn) {
...
bool SpnCheck_isSpnEnabled(const struct AppConfig* cfg, uint16_t spn) {
